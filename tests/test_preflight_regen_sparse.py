    ...
    def test_a_bad_token_leaves_its_value_out_instead_of_aborting(self):
        ...
        cases = {
            ...
            "non-numeric slot": ('/ch/01/config "Kick" 2 YEi 1', '/ch/01/config "Kick" 2 YEi X',
                                 ("source", "gain", "phantom")),
            "gain abc": ("/headamp/000 +27.5 OFF", "/headamp/000 abc OFF", ("gain",)),
            "gain -oo": ("/headamp/000 +27.5 OFF", "/headamp/000 -oo OFF", ("gain",)),
            "gain nan": ("/headamp/000 +27.5 OFF", "/headamp/000 nan OFF", ("gain",)),
            "gain inf": ("/headamp/000 +27.5 OFF", "/headamp/000 inf OFF", ("gain",)),
